...
@section('body')
<section class="container max-w-6xl mx-auto px-6 lg:py-10 md:py-12">
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24 w-full">
        <div class="mt-8">
            <h1 id="intro-docs-template">{{ $page->siteName }}</h1>

            <h2 id="intro-powered-by-jigsaw" class="font-light mt-4">{{ $page->siteDescription }}</h2>

            <p class="text-lg">Unattended deployment script for PHP projects based on git.</p>
            ...
            <div class="flex my-10">
                ...
                <a href="https://kodilab.com" title="Deployer by Kodilab" class="bg-gray-400 hover:bg-gray-600 text-blue-900 font-normal hover:text-white rounded py-2 px-6">About Kodilab</a>
            </div>
        </div>

        <div class="w-full lg:w-1/2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1066 773.96">
                <path d="M995.19 369.87c.59-6.77.9-13.65.9-20.6 0-108.83-73.84-197.06-164.92-197.06-29 0-56.34 9-80 24.75-64.47-50-148.64-80.21-240.72-80.21-149.83 0-278.71 80.07-335.89 194.9a138.6 138.6 0 00-9.6-.34C73.83 291.31 0 379.53 0 488.36c0 40 10 77.23 27.14 108.31 0 97.91 78.45 177.31 175.22 177.31h122l.54-.93c7.17-11.64 24.34-14.55 36.3-7.94 3.16 1.74 6.1 4 9.63 4.8 14.13 3 23.62-19.73 37.92-17.52 7.18 1.11 12.78 8.53 20 7.77 4.79-.51 8.42-4.52 12.92-6.22 7.21-2.74 14.52 1.06 19.57 7.23 2.93-8.43 2.91-18.42 7.65-26.15 7.17-11.64 24.34-14.55 36.3-7.94 3.16 1.74 6.1 4 9.63 4.8 14.13 3 23.62-19.73 37.92-17.52 7.18 1.11 12.78 8.53 20 7.77 4.79-.51 8.42-4.52 12.92-6.22 11.22-4.27 22.71 7.32 25.47 19a81 81 0 011.69 15.64c9.68-4.69 17.86-17.88 28.91-16.17 7.18 1.11 12.78 8.53 20 7.77 4.79-.51 8.42-4.52 12.92-6.22 11.22-4.27 22.71 7.32 25.47 19 1.47 6.2 1.57 12.64 1.82 19h202.15c76 0 137.58-62.32 137.58-139.2 15.42-30 24.33-65.28 24.33-103.06 0-67-28-126.2-70.81-161.8z" fill="#6c63ff" opacity=".1"/>
                <circle cx="623" cy="179" r="87" fill="#6c63ff"/>
                <path fill="#fff" d="M594.99 182.28l27.87-27.87 28.15 27.87h-19.13v21.31h-17.76v-21.17l-19.13-.14zM737.52 401.2a29.75 29.75 0 00-55.63-8 23.81 23.81 0 002.58 47.48h51.66A19.93 19.93 0 00756 420.86a19.62 19.62 0 00-18.48-19.66zm-22.85 11.72v15.06H702v-15.1h-13.55l19.87-19.87 19.86 19.87zM889.52 648.2a29.75 29.75 0 00-55.63-8 23.81 23.81 0 002.58 47.48h51.66A19.93 19.93 0 00908 667.86a19.62 19.62 0 00-18.48-19.66zm-22.85 11.72v15.06H854v-15.1h-13.55l19.87-19.87 19.86 19.87zM329.45 469.98a46 46 0 00-86-12.28 36.8 36.8 0 004 73.38h79.85a30.8 30.8 0 0030.7-30.72 30.33 30.33 0 00-28.55-30.38zm-35.31 18.1v23.34h-19.65v-23.34h-20.88l30.71-30.7 30.68 30.7zM673 549.98v-24.3l11.2 11.2 2.8-2.9-16-16-16 16 2.8 2.8 11.2-11.1v24.3zM114 582.98v-24.3l11.2 11.2 2.8-2.9-16-16-16 16 2.8 2.8 11.2-11.1v24.3zM672 320.98v-18.21l8.4 8.4 2.1-2.17-12-12-12 12 2.1 2.1 8.4-8.33v18.21zM453 188.98v-18.21l8.4 8.4 2.1-2.17-12-12-12 12 2.1 2.1 8.4-8.33v18.21zM371 368.98v-18.21l8.4 8.4 2.1-2.17-12-12-12 12 2.1 2.1 8.4-8.33v18.21zM885 452.98v-18.21l8.4 8.4 2.1-2.17-12-12-12 12 2.1 2.1 8.4-8.33v18.21zM353 613.98v-18.21l8.4 8.4 2.1-2.17-12-12-12 12 2.1 2.1 8.4-8.33v18.21z"/>
                ...
                <path fill="#3f3d56" d="M482.75 670.03l.07-5.63-3.38-.04-.07 5.63-5.83 16.84 14.65.17-5.44-16.97zM587.17 671.42l.07-5.78-3.47-.04-.07 5.78-5.98 17.26 15.02.18-5.57-17.4zM602.19 671.6l.07-5.78-3.47-.04-.07 5.78-5.98 17.26 15.02.18-5.57-17.4zM617.21 671.78l.07-5.78-3.47-.04-.07 5.78-5.98 17.26 15.02.18-5.57-17.4zM518.99 670.61l.07-5.78-3.47-.04-.07 5.78-5.98 17.26 15.02.18-5.57-17.4zM534.01 670.79l.07-5.78-3.46-.04-.07 5.78-5.99 17.26 15.02.18-5.57-17.4zM549.03 670.97l.07-5.78-3.46-.04-.07 5.78-5.99 17.26 15.03.18-5.58-17.4z"/>
                <path d="M508.76 266.58c-.21-19.9-23.65-55.18-36.3-55.33s-35.78 34.57-36.46 54.46h-.6l-4.77 399.81 73.38.87 4.77-399.8zM642.8 268.18c-.21-19.9-23.65-55.18-36.3-55.33s-35.78 34.57-36.45 54.46h-.6l-4.77 399.81 73.38.87 4.77-399.8z" fill="#3f3d56"/>
                <path d="M576.86 80.92C576.75 51.75 553.5.15 540.86 0s-36 50.89-36.77 80h-.59l-7 586.24 73.37.88 7-586.25z" fill="#2f2e41"/>
                <path fill="#6c63ff" d="M509.13 395.43l27.88-27.88 28.14 27.88h-19.12v21.31h-17.77v-21.18l-19.13-.13z"/>
                <g opacity=".1">
                ...
                <rect x="600.73" y="88.44" width="13.87" height="30.05" rx="6.93" transform="rotate(.68 5887.073 -5572.534)" fill="#ececf3"/>
            </svg>
        </div>
    </div>
